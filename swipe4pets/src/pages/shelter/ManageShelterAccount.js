    ...
    <div class="center">
      ...
      <form>
        <div class="shelter-signup">
          ...
          <input type='text' id='phone-number' name='phone-number' placeholder="555-555-5555"></input>
          <br></br> <br></br>

          <label>Street Address</label> <br></br>
          <input type='text' id='street-address' name='street-address' placeholder="77 circle dr"></input>
          <br></br> <br></br>
          ...
          <input type='text' id='state' name='state' placeholder="New York"></input>
          <br></br> <br></br>

          <label>ZIP code</label> <br></br>
          <input type='text' id='zip-code' name='zip-code' placeholder="55555"></input>
          <br></br> <br></br>
          ...
          <input type='email' id='email' name='email' placeholder="shelter@shelter.com"></input>
          <br></br> <br></br>
