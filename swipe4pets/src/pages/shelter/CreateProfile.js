    ...
    <div>
      <form>
        <div class="col-md-4 mb-3 offset-md-4">
          ...
          <div class="form-group">
            <label for="dispositions" class="mb-2">Dispositions</label>
          </div>


          <div class="form-check-inline">
            <input type="checkbox" class="form-check-input" id="check0"></input>
            <label class="form-check-label" for="check0">Good with other animals</label>
          </div>
          <div class="form-check-inline">
            <input type="checkbox" class="form-check-input mb-2" id="check1"></input>
            <label class="form-check-label" for="check1">Good with children</label>
          </div>
